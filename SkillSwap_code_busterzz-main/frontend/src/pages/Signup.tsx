...
import { Moon, Sun, Users, Eye, EyeOff } from 'lucide-react';
    ...
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <main className="flex-1 flex items-center justify-center p-4">
        <Card className="w-full max-w-md shadow-lg">
          <CardHeader>
            <CardTitle className="text-3xl text-center font-bold">Join Us Today</CardTitle>
            <p className="text-center text-muted-foreground">Create your account to start skill swapping</p>
          </CardHeader>
          <CardContent>
